...
export class StableDebtToken extends ethereum.SmartContract {
  ...
  try_getSupplyData(): ethereum.CallResult<StableDebtToken__getSupplyDataResult> {
    let result = super.tryCall(
      "getSupplyData",
      "getSupplyData():(uint256,uint256,uint256,uint40)",
      [],
  ...
  try_getTotalSupplyAndAvgRate(): ethereum.CallResult<StableDebtToken__getTotalSupplyAndAvgRateResult> {
    let result = super.tryCall(
      "getTotalSupplyAndAvgRate",
      "getTotalSupplyAndAvgRate():(uint256,uint256)",
      [],
